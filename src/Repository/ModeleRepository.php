...
class ModeleRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(Modele $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Modele $entity, bool $flush = true): void
    {
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?Modeley
    {
        return $this->createQueryBuilder('c')
            ->andWhere('c.exampleField = :val')
            ->setParameter('val', $value)
